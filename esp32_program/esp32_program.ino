...
const char* ssid = "TP-Link_AA68";
const char* password = "95262086";
int status;
...
String getdata()
{
  ...
  return (String)temp + "," + (String)prs + "," + (String)ax  + "," + (String)ay  + "," + (String)az  + "," + (String)gx + "," + (String)gy  + "," + (String)gz +","+ (String)distt;
}
